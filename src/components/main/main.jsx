...
function Main({specialMovie, movies, onMovieCardTitleClick: handleMovieCardTitleClick}) {
  return (
    <>
      <section className="movie-card">
        <div className="movie-card__bg">
          <img src={specialMovie.background} alt={specialMovie.name}/>
        </div>
        ...
        <div className="movie-card__wrap">
          <div className="movie-card__info">
            <div className="movie-card__poster">
              <img src={specialMovie.poster} alt={specialMovie.name} width="218" height="327"/>
            </div>
